...
static const field_desc_t cascade_telem_fields[CASC_TELEM_FIELD_COUNT] = {
    ...
    FIELD(cascade_telemetry_t, current_a,      PTYPE_FLOAT),   /* [3]  */
    FIELD(cascade_telemetry_t, target,         PTYPE_FLOAT),   /* [4]  */
    FIELD(cascade_telemetry_t, vel_sp,         PTYPE_FLOAT),   /* [5]  */
    FIELD(cascade_telemetry_t, current_sp,     PTYPE_FLOAT),   /* [6]  */
    FIELD(cascade_telemetry_t, ff,             PTYPE_FLOAT),   /* [7]  */
    FIELD(cascade_telemetry_t, power,          PTYPE_FLOAT),   /* [8]  */
    FIELD(cascade_telemetry_t, pos_p,          PTYPE_FLOAT),   /* [9]  */
    FIELD(cascade_telemetry_t, pos_i,          PTYPE_FLOAT),   /* [10] */
    FIELD(cascade_telemetry_t, pos_d,          PTYPE_FLOAT),   /* [11] */
    FIELD(cascade_telemetry_t, vel_p,          PTYPE_FLOAT),   /* [12] */
    FIELD(cascade_telemetry_t, vel_i,          PTYPE_FLOAT),   /* [13] */
    FIELD(cascade_telemetry_t, vel_d,          PTYPE_FLOAT),   /* [14] */
    FIELD(cascade_telemetry_t, vel_integral,   PTYPE_FLOAT),   /* [15] */
    FIELD(cascade_telemetry_t, trq_p,          PTYPE_FLOAT),   /* [16] */
    FIELD(cascade_telemetry_t, trq_i,          PTYPE_FLOAT),   /* [17] */
    FIELD(cascade_telemetry_t, trq_d,          PTYPE_FLOAT),   /* [18] */
    FIELD(cascade_telemetry_t, trq_integral,   PTYPE_FLOAT),   /* [19] */
    FIELD(cascade_telemetry_t, mode,           PTYPE_UINT8),   /* [20] */
};
