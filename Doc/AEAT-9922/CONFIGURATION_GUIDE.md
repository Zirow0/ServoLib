...
> **ЗАСТАРІЛИЙ ДОКУМЕНТ.** Датчик AEAT-9922 та весь відповідний код (`aeat9922.h/c`) повністю видалено з проекту.
> Цей файл залишено лише як архівний довідник по апаратному налаштуванню датчика.
> Для поточних датчиків положення див. `Inc/drv/position/incremental_encoder.h` або `Inc/drv/position/as5600.h`.
